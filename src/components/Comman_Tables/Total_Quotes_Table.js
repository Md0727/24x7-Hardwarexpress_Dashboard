...
function Integration({totalQuotation}) {
    ...
    return (
        <>
            <TitleCard title="Total Quotes" topMargin="mt-2" TopSideButtons={<TopSideButtons searchTextDataFun={searchTextDataFun} ClearData={ClearData} setSearchText={setSearchText} searchText={searchText} />}>
