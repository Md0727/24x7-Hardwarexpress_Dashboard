...
import Hot_Deals_form from "../../components/InformationForm/Hot_Deals_form"
                            ...
                            <div className="w-full border-2 p-5 rounded-md border-gray-400 border-dashed ">
                                ...
                                <div className="text-center">
                                    <ButtonCustome
                                        ...
                                        buttonTitle="Add New Hot Deals Banner"
                                        type="text"
                                        onClick={addProduct}
                                    />
                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td className="text-left text-blue font-poppins not-italic font-md dark:text-white">
                                                            <div className='max-w-xl w-16'>
                                                                <img src={item?.url} className='w-full h-auto' alt="product image" />
                                                            </div>
                                                        </td>
