...
function Integration() {
    ...
    const [tabIndex, setTabIndex] = useState('QR');
    ...
    const handleOnChangeTags = (event, newValue) => {
        let updateResult = { ...inputValue }
        updateResult.tags = newValue;
    ...
    const handlerCareInstruction = (e) => {
        const updatedItems = { ...inputValue };
        updatedItems.careInstruction = e.target.value;
        setInputValue(updatedItems);
    }

    const handlerColor = (e) => {
        const updatedItems = { ...inputValue };
        updatedItems.color = e.target.value;
        setInputValue(updatedItems);
    }

    const handlerFurnitureOfType = (e) => {
        const updatedItems = { ...inputValue };
        updatedItems.furnitureType = e.target.value;
        setInputValue(updatedItems);
    }
    ...
    // switch box function code ===========
    const tabHandler = (index) => {
        const updatedItems = { ...inputValue };
        updatedItems.typeOfBarCode = index;
        setInputValue(updatedItems);
        setTabIndex(index)
    }
    ...
    const getProductType = () => {
        setIsLoading(true)
        let config = {
            url: ApiUrl?.getProductsType,
            method: 'post',
            body: {
                "type": inputValue?.category //Furniture
            }
        }
        APIRequest(
            config,
            res => {
                inputValue?.category ? setProductType(res?.data) : setProductType([])
                console.log(inputValue?.category, "inputValue?.category")
                setIsLoading(false)
            },
            err => {
                setIsLoading(false)
            ...
            <div className="bg-white">
                ...
                <div className="mb-4">
                    ...
                    <div className="flex gap-2 mb-3 justify-between">
                        ...
                        <div className="w-full">
                            <label htmlFor="" className="block">SKU<span className="text-red">*</span></label>
                            <InputCustome2
                                placeholder={'Select SKU'}
                                type="text"
                                searchValue={inputValue.sku}
                                icon={false}
                                name="sku"
                                onChange={(e) => changeInputHandler(e)}
                                className="outline-none w-full text-left rounded-lg px-3 py-2 placeholder:text-black bg-cyan600 text-black"
                    ...
                    <div className="flex gap-2 mb-3 justify-between">
                        ...
                        <div className="w-full">
                            <label htmlFor="" className="block">Sub Category <span className="text-red">*</span></label>
                            <InputCustome2
                                placeholder={'Sub category'}
                                type="text"
                                searchValue={inputValue.subCategory}
                                icon={false}
                                name="subCategory"
                                onChange={(e) => changeInputHandler(e)}
                                className="outline-none w-full text-left rounded-lg px-3 py-2 placeholder:text-black bg-cyan600 text-black"
                        ...
                        <div className="w-full">
                            <label htmlFor="" className="block">Alert Query</label>
                            <InputCustome2
                                placeholder={'Yes, if not write NA'}
                                type="text"
                                searchValue={inputValue.alertQuery}
                                icon={false}
                                name="alertQuery"
                                onChange={(e) => changeInputHandler(e)}
                                className="outline-none w-full text-left rounded-lg px-3 py-2 placeholder:text-black bg-cyan600 text-black"
                    ...
                    <div className="flex gap-2 mb-3 justify-between">
                        ...
                        <div className="w-full">
                            <label htmlFor="" className="block">Exc. Tax <span className="text-red">*</span></label>
                            <InputCustome2
                                placeholder={'Exc. Tax'}
                                type="text"
                                searchValue={inputValue.excTax}
                                icon={false}
                                name="excTax"
                                onChange={(e) => changeInputHandler(e)}
                                className="outline-none w-full text-left rounded-lg px-3 py-2 placeholder:text-black bg-cyan600 text-black"
                    ...
                    <div className="flex gap-2 mt-3 justify-between">
                        ...
                        <div className="w-full">
                            <label htmlFor="" className="block">Product Specification <span className="text-red">*</span></label>
                            <InputCustome2
                                placeholder={'Product Specification'}
                                type="text"
                                searchValue={inputValue.specification}
                                icon={false}
                                name="specification"
                                onChange={(e) => changeInputHandler(e)}
                                className="outline-none w-full text-left rounded-lg px-3 py-2 placeholder:text-black bg-cyan600 text-black"
                        ...
                        <div className="w-full">
                            <label htmlFor="" className="block">Custom field 1 <span className="text-red">*</span></label>
                            <InputCustome2
                                placeholder={'Custom field 1'}
                                type="text"
                                searchValue={inputValue.customFiled}
                                icon={false}
                                name="customFiled"
                                onChange={(e) => changeInputHandler(e)}
                                className="outline-none w-full text-left rounded-lg px-3 py-2 placeholder:text-black bg-cyan600 text-black"
                    ...
                    <div className="flex gap-2 mt-3 justify-between">
                        <div className="w-full">
                            <label htmlFor="" className="block">Tags <span className="text-red">*</span></label>
                            <MultipleSelect
                                className="outline-none w-full text-left rounded-lg px-3 py-2 placeholder:text-black bg-cyan600 text-black"
                                optionArr={typeTags}
                        ...
                        <div className="w-full">
                            <label htmlFor="" className="block">Care Instruction <span className="text-red">*</span></label>
                            <select name="seatCap" onChange={handlerCareInstruction} id="seatCap" className="outline-none w-full text-left rounded-lg px-3 py-2 placeholder:text-black bg-cyan600 text-black">
                                <option value="">Selected</option>
                                <option value="Washable Fabric">Washable Fabric</option>
                                <option value="No care qequired">No care qequired</option>
                            </select>
                        </div>
                        <div className="w-full">
                            <label htmlFor="" className="block">Color <span className="text-red">*</span></label>
                            <select name="seatCap" onChange={handlerColor} id="seatCap" className="outline-none w-full text-left rounded-lg px-3 py-2 placeholder:text-black bg-cyan600 text-black">
                                <option value="">Selected</option>
                        ...
                        <div className="w-full">
                            <label htmlFor="" className="block">{inputValue.category === "Furniture" ? "Furniture" : "Appliances"} of Type <span className="text-red">*</span></label>
                            <select name="seatCap" onChange={handlerFurnitureOfType} id="seatCap" className="outline-none w-full text-left rounded-lg px-3 py-2 placeholder:text-black bg-cyan600 text-black">
                                <option value="">Selected</option>
                                {
                                    productType?.map((tag) => (
                    ...
                    <div>
                        <div className="flex sm:flex-wrap justify-between gap-3">
                            <div className="w-72">
                                <div className='mb-3'>
                                    <p className='text-blue mb-2 mt-3 font-poppins'>Type of BarCode</p>
                                    <div class="inline-flex items-center" onClick={() => tabHandler("QR")}>
                                        <label class="relative flex items-center p-2 rounded-full cursor-pointer" htmlFor="tab01">
                                            <input name="type" type="radio"
                                                ...
                                                id={'tab01'} checked={`${tabIndex === "QR" ? 'checked' : ''}`} />
                                            <span
                                    ...
                                    <div class="inline-flex items-center" onClick={() => tabHandler("BarCode")}>
                                        <label class="relative flex items-center p-2 rounded-full cursor-pointer" htmlFor="tab02">
                                            <input name="type" type="radio"
                                                class="before:content[''] peer relative h-5 w-5 cursor-pointer appearance-none rounded-full border border-blue-gray-200 text-blue transition-all before:absolute before:top-2/4 before:left-2/4 before:block before:h-12 before:w-12 before:-translate-y-2/4 before:-translate-x-2/4 before:rounded-full before:bg-blue-gray-500 before:opacity-0 before:transition-opacity"
                                                id={'tab02'} checked={`${tabIndex === "BarCode" ? 'checked' : ''}`} />
                                            <span
                                                class="absolute text-blue transition-opacity opacity-0 pointer-events-none top-2/4 left-2/4 -translate-y-2/4 -translate-x-2/4 peer-checked:opacity-100">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5" viewBox="0 0 16 16" fill="currentColor">
                                                    <circle data-name="ellipse" cx="8" cy="8" r="8"></circle>
